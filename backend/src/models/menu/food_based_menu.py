...
class FoodRecommendationModel(MenuBaseModel):
    """
    Represents a food-item prescription structured directly around fixing identified micronutrient deficiencies.
    """

    recommendation_type: MenuType = Field(
        default=MenuType.FOOD_ITEMS,
        description="Hardcoded type discriminator to isolate this structure during serialization."
    )
