...
from src.http_handlers.profile.get_my_profile import handler as get_me_handler
from src.http_handlers.profile.get_profile_by_id import handler as get_profile_handler
...
ROUTES = [
    ...
    ("GET", "profile/{cognito_sub}", get_profile_handler),
